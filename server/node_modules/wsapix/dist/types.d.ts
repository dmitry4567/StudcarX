 ...
 */
export declare type MessageValidator = (schema: any, data: any, error: (msg: string) => void) => boolean;
/**
 * Parser/Serializer function
 * @param data - Serialized/Parsed data
 * @returns Parser/Serialized data
 */
export declare type DataParser = (data: any) => any;
/**
 ...
 * @param data - message payload
 */
export declare type MessageHandler<S, T = any> = (client: WsapixClient<S>, data: T) => void;
/**
 ...
 * ```
 */
export declare type MessageMatcher = {
    [key: string]: string;
} | ((data: any) => boolean);
/**
 *
...
export declare type WsapixClient<S = any> = Client & {
    /**
 ...
 */
export declare type WsapixMiddleware<T> = (client: WsapixClient<T>) => void | Promise<void>;
