...
export interface SecuritySchema {
    ...
    name: string;
    flows: {
        [key in Oauth2FlowType]: Oauth2Flow;
    };
...
export declare enum BearerHttpSecurityScheme {
    BEARER = "bearer"
}
export declare enum Oauth2FlowType {
    implicit = 0,
    password = 1,
    clientCredentials = 2,
    authorizationCode = 3
...
export declare type JsonSchema = JsonSchemaBase | JsonSchemaNumber | JsonSchemaString | JsonSchemaGeneric | JsonSchemaObject | JsonSchemaArray | JsonSchemaObject | JsonSchemaMix;
declare type JsonSchemaMix = JsonSchemaBase & JsonSchemaNumber & JsonSchemaString & JsonSchemaGeneric & JsonSchemaObject & JsonSchemaArray & JsonSchemaObject & {
